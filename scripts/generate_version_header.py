...
def generate_header_custom( repo_dir: PathLike,
    ...
    with open(output_file, 'w') as output:
        ...
        if version.prerelease:
            output.write(f'#define {component_prefix}_VERSION_PRERELEASE_TEXT "{version.prerelease}"\n')
        else:
            output.write(f'// #define {component_prefix}_VERSION_PRERELEASE_TEXT "placeholder"\n')
